...
COPYRIGHT := $(GOBIN)/copyright-v0.0.0-20220817170617-6c25e3b627dd
$(COPYRIGHT): $(BINGO_DIR)/copyright.mod
	@# Install binary/ries using Go 1.14+ build command. This is using bwplotka/bingo-controlled, separate go module with pinned dependencies.
	@echo "(re)installing $(GOBIN)/copyright-v0.0.0-20220817170617-6c25e3b627dd"
	@cd $(BINGO_DIR) && $(GO) build -mod=mod -modfile=copyright.mod -o=$(GOBIN)/copyright-v0.0.0-20220817170617-6c25e3b627dd "github.com/efficientgo/tools/copyright"
